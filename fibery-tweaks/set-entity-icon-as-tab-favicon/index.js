...
function fiberflowSetEntityIconAsTabFavicon() {
  ...
  var entityEmoji = (document.querySelector('.object_panel .entity_emoji_picker span') || {}).textContent;
  ...
  const entityAvatar = (document.querySelector('.object_panel .content_header .avatar img') || {}).src;
  if (entityAvatar) {
  ...
  var pageEmoji = (document.querySelector('.core_content .view_icon .emoji') || {}).textContent;
  ...
  // Check for page icon
  const pageIcon = document.querySelector('.core_content .view_icon_picker svg');
